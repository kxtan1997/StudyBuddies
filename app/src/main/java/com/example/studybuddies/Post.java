...
public class Post {
    ...
    public Post(String posterID, String posterUsername, String postID, String postTitle, String postDescription, String subject, HashMap<String, Comment> comments, int rating, HashMap<String, Integer> raterUID) {
